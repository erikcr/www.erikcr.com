...
export const story = {
  ...
  description:
    "Beginning a new job is always filled with surprises, but this time it was more than I bargained for. What was meant to be a brief business trip ended up as a week long odyssey during an unprecedented London snow storm.",
};
...
<Image
  src="/e0c757d0-41f7-4cd5-8a54-6c5846d93714.webp"
  width="718"
  height="404"
  alt="When It Rains it Pours... and Sometimes More"
/>
