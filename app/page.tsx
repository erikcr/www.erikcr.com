...
export default async function Home() {
  let stories = (await getAllStories()).slice(0, 4);
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Solution designer, developer, and amateur filmmaker.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Erik, a self-motivated solution designer and developer with a
            propensity for videography and film. I spent over three years living
            in Europe while working for a Singapore-based computer vision
            company. Following that as a Solutions Consultant for an
            Estonia-based autonomous negotiation software company. I currently
            travel in a converted mini school bus exploring the US and Mexico.
          </p>
